...
let nameInput = formElement.querySelector('.input_name') // Воспользуйтесь инструментом .querySelector()
let jobInput = formElement.querySelector('.input_about') // Воспользуйтесь инструментом .querySelector()
